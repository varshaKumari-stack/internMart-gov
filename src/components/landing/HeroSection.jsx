...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* 🔴 GLITCH WARNING TEXT */}
      {glitch && (
        <div className="absolute top-10 left-1/2 -translate-x-1/2 z-30 text-red-400 text-xs animate-pulse">
          SYSTEM INSTABILITY
        </div>
      )}
      ...
      <motion.p
        ...
        className="mt-6 bg-yellow-300 text-black inline-block px-5 py-3 font-black rotate-1 shadow-lg"
      >
      ...
      <motion.p
        ...
        className="mt-2 italic text-sm text-zinc-300"
      >
      ...
      >
        <Link
          to="/login"
          className="bg-red-600 px-8 py-4 rounded-full text-xl font-black transition hover:scale-110 hover:shadow-[0_0_30px_rgba(255,0,0,0.5)]"
        >
          LOGIN
        </Link>
        ...
        >
          <Link
            to="/signup"
            className="bg-lime-400 text-black px-8 py-4 rounded-full text-xl font-black transition hover:scale-110 hover:shadow-[0_0_30px_rgba(0,255,0,0.4)]"
          >
            SIGNUP
          </Link>
        </motion.div>
